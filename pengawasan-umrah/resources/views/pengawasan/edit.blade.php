            ...
            <div class="card-body">
                ...
                <form class="row g-2 mt-3" action="/pengawasan/update/{{ $pengawasan->id }}" method="POST" id="form" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input autofocus type="number" min="0" class="form-control @error('jumlah_jemaah_laki_laki') is-invalid @enderror" id="input1" name="jumlah_jemaah_laki_laki" value="{{ old('jumlah_jemaah_laki_laki', $pengawasan->jumlah_jemaah_laki_laki) }}">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input autofocus type="number" min="0" class="form-control @error('jumlah_jemaah_wanita') is-invalid @enderror" id="input1" name="jumlah_jemaah_wanita" value="{{ old('jumlah_jemaah_wanita', $pengawasan->jumlah_jemaah_wanita) }}">
